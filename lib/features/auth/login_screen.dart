              ...
              children: [
                Expanded(
                  child: SizedBox(
                    ...
                    child: GestureDetector(
                      onTap: () => setState(() => _selectedAccountType = 'customer'),
                      child: Container(
                        padding: const EdgeInsets.all(15),
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: _selectedAccountType == 'customer' ? Colors.black : Colors.grey,
                          ),
                ...
                Expanded(
                  child: SizedBox(
                    height: 70,
                    child: GestureDetector(
                      onTap: () => setState(() => _selectedAccountType = 'sales_point'),
                      child: Container(
                        padding: const EdgeInsets.all(15),
                        decoration: BoxDecoration(
                          border: Border.all(
                            color: _selectedAccountType == 'sales_point' ? Colors.black : Colors.grey,
                          ),
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: const Row(
